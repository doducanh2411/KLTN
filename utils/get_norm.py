...
def get_norm(model_name):
    ...
    if model_name == 'single_frame' or model_name == 'early_fusion' or model_name == 'late_fusion' or model_name == 'cnn_lstm' or model_name == 'multimodal_cnn_lstm' or model_name == 'attention_late_fusion':
